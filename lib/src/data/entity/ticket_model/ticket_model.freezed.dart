...
mixin _$TicketModel {
 ...
 String get id;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;@JsonKey(name: 'qr_code') String get qrCode;@JsonKey(name: 'is_checked') bool get isChecked; int get debate; String get user;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,updatedAt,qrCode,isChecked,debate,user);

@override
String toString() {
  return 'TicketModel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, qrCode: $qrCode, isChecked: $isChecked, debate: $debate, user: $user)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt,@JsonKey(name: 'qr_code') String qrCode,@JsonKey(name: 'is_checked') bool isChecked, int debate, String user
});
...
/// Create a copy of TicketModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? qrCode = null,Object? isChecked = null,Object? debate = null,Object? user = null,}) {
...
as bool,debate: null == debate ? _self.debate : debate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt, @JsonKey(name: 'qr_code')  String qrCode, @JsonKey(name: 'is_checked')  bool isChecked,  int debate,  String user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TicketModel() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.qrCode,_that.isChecked,_that.debate,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt, @JsonKey(name: 'qr_code')  String qrCode, @JsonKey(name: 'is_checked')  bool isChecked,  int debate,  String user)  $default,) {final _that = this;
switch (_that) {
case _TicketModel():
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.qrCode,_that.isChecked,_that.debate,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt, @JsonKey(name: 'qr_code')  String qrCode, @JsonKey(name: 'is_checked')  bool isChecked,  int debate,  String user)?  $default,) {final _that = this;
switch (_that) {
case _TicketModel() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.qrCode,_that.isChecked,_that.debate,_that.user);case _:
  return null;
...
class _TicketModel implements TicketModel {
  const _TicketModel({required this.id, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'qr_code') required this.qrCode, @JsonKey(name: 'is_checked') required this.isChecked, required this.debate, required this.user});
...
/// Create a copy of TicketModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? updatedAt = null,Object? qrCode = null,Object? isChecked = null,Object? debate = null,Object? user = null,}) {
